...
import { Package, LogOut, Leaf } from "lucide-react";
...
export default function StaffLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    { name: "Stok & Bahan Baku", icon: Package, path: "/staff/inventory" },
  ];
      ...
      <aside className="w-64 bg-[#4318FF] text-white flex flex-col z-20 relative shadow-2xl md:rounded-r-[2.5rem] flex-shrink-0">
        ...
        <div className="p-8 flex items-center gap-3 relative z-10">
          ...
          <div>
            ...
            <p className="text-[9px] text-indigo-200 font-bold tracking-widest uppercase mt-0.5">POS Inventory</p>
          </div>
        </div>
